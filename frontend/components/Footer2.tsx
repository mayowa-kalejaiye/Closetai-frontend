    ...
    <footer className="py-10 px-4 sm:px-6 lg:px-8 font-inter relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10">
        <div className="mb-6 flex items-center justify-center">
          <div className="inline-flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full mr-3">
            <span className="text-lg font-bold text-gray-900 font-dancing-script">C</span>
          </div>
          <span className="text-gray-900 text-3xl font-extrabold tracking-wide font-space-grotesk">
            ClosetAI
          </span>
        </div>
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-500 mt-4">
          &copy; {new Date().getFullYear()} ClosetAI. Revolutionizing fashion with AI.
        </p>
      </div>
    </footer>
  );
