...
const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Seasonal style recommendations', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Personal stylist consultations', included: true },
...
const PricingCard: React.FC<PricingCardProps> = ({ plan }) => {
  ...
  return (
    <div className={cardClasses}>
      ...
      <h3 className="text-2xl font-bold text-gray-800 dark:text-zinc-100 mb-4 font-space-grotesk">{plan.name}</h3>
